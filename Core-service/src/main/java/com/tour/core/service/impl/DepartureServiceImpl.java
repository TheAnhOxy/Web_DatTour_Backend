...
public class DepartureServiceImpl implements DepartureService {
    ...
    @Override
    @Cacheable(value = "departures_v2", key = "'tour:' + #tourId")
    ...
    @Override
    @Cacheable(value = "departures_v2", key = "'page:' + #tourId + ':' + (#status == null || #status.isBlank() ? 'ALL' : #status.trim().toUpperCase()) + ':' + #page + ':' + #size")
    @Transactional(readOnly = true)
    ...
    @Override
    @Cacheable(value = "departures_v2", key = "#id")
    @Transactional(readOnly = true)
    ...
    @Override
    @CacheEvict(value = {"departures_v2", "tours_v2"}, allEntries = true)
    @Transactional
